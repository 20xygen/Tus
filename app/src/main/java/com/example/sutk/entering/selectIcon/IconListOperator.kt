package com.example.sutk.entering.selectIcon
...
class IconListOperator {
    ...
    public fun postInit(post_binding: FragmentSelectingPostIconBinding) {
        ...
        Companion.post_binding = post_binding
    }
    ...
    fun setPostIcon (view: ImageView, id: Int){
        when(id){
            0 -> view.setImageResource(R.drawable.ip__1_)
            1 -> view.setImageResource(R.drawable.ip__2_)
            2 -> view.setImageResource(R.drawable.ip__3_)
            3 -> view.setImageResource(R.drawable.ip__4_)
            4 -> view.setImageResource(R.drawable.ip__5_)
            5 -> view.setImageResource(R.drawable.ip__6_)
            6 -> view.setImageResource(R.drawable.ip__7_)
            7 -> view.setImageResource(R.drawable.ip__8_)
            8 -> view.setImageResource(R.drawable.ip__9_)
            9 -> view.setImageResource(R.drawable.ip__10_)
            10 -> view.setImageResource(R.drawable.ip__11_)
            11 -> view.setImageResource(R.drawable.ip__12_)
            12 -> view.setImageResource(R.drawable.ip__13_)
            13 -> view.setImageResource(R.drawable.ip__14_)
            14 -> view.setImageResource(R.drawable.ip__15_)
            15 -> view.setImageResource(R.drawable.ip__16_)
            16 -> view.setImageResource(R.drawable.ip__17_)
            17 -> view.setImageResource(R.drawable.ip__18_)
            18 -> view.setImageResource(R.drawable.ip__19_)
            19 -> view.setImageResource(R.drawable.ip__20_)
            20 -> view.setImageResource(R.drawable.ip__21_)
            21 -> view.setImageResource(R.drawable.ip__22_)
            22 -> view.setImageResource(R.drawable.ip__23_)
            23 -> view.setImageResource(R.drawable.ip__24_)
            24 -> view.setImageResource(R.drawable.ip__25_)
            25 -> view.setImageResource(R.drawable.ip__26_)
            26 -> view.setImageResource(R.drawable.ip__27_)
            27 -> view.setImageResource(R.drawable.ip__28_)
            28 -> view.setImageResource(R.drawable.ip__29_)
            29 -> view.setImageResource(R.drawable.ip__30_)
            30 -> view.setImageResource(R.drawable.ip__31_)
            31 -> view.setImageResource(R.drawable.ip__32_)
            32 -> view.setImageResource(R.drawable.ip__33_)
            33 -> view.setImageResource(R.drawable.ip__34_)
            34 -> view.setImageResource(R.drawable.ip__35_)
            35 -> view.setImageResource(R.drawable.ip__36_)
            36 -> view.setImageResource(R.drawable.ip__37_)
            37 -> view.setImageResource(R.drawable.ip__38_)
            38 -> view.setImageResource(R.drawable.ip__39_)
            39 -> view.setImageResource(R.drawable.ip__40_)
            40 -> view.setImageResource(R.drawable.ip__41_)
            41 -> view.setImageResource(R.drawable.ip__42_)
            42 -> view.setImageResource(R.drawable.ip__43_)
            43 -> view.setImageResource(R.drawable.ip__44_)
            44 -> view.setImageResource(R.drawable.ip__45_)
            45 -> view.setImageResource(R.drawable.ip__46_)
            46 -> view.setImageResource(R.drawable.ip__47_)
            47 -> view.setImageResource(R.drawable.ip__48_)
            48 -> view.setImageResource(R.drawable.ip__49_)
            49 -> view.setImageResource(R.drawable.ip__50_)
            50 -> view.setImageResource(R.drawable.ip__51_)
            51 -> view.setImageResource(R.drawable.ip__52_)
            52 -> view.setImageResource(R.drawable.ip__53_)
            53 -> view.setImageResource(R.drawable.ip__54_)
            54 -> view.setImageResource(R.drawable.ip__55_)
            55 -> view.setImageResource(R.drawable.ip__56_)
            56 -> view.setImageResource(R.drawable.ip__57_)
            57 -> view.setImageResource(R.drawable.ip__58_)
            58 -> view.setImageResource(R.drawable.ip__59_)
            59 -> view.setImageResource(R.drawable.ip__60_)
            60 -> view.setImageResource(R.drawable.ip__61_)
            61 -> view.setImageResource(R.drawable.ip__62_)
            62 -> view.setImageResource(R.drawable.ip__63_)
        }
    }
