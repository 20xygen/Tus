...
import com.example.sutk.databinding.FragmentFeedRootBinding


/**
 * A simple [Fragment] subclass as the second destination in the navigation.
 */
class FeedRootFragment : Fragment() {
    private var currentFragment: Int? = 1
    public var navController: NavigationController? = NavigationController()
    private var _binding: FragmentFeedRootBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFeedRootBinding.inflate(inflater, container, false)
        return binding.root
    }
